...
interface PeelCornerOfferCardProps {
  onClose?: () => void;
}

export default function PeelCornerOfferCard({ onClose }: PeelCornerOfferCardProps) {
  ...
  return (
    <>
      {/* Peel Corner Card */}
      {isVisible && !isPeeling && !showForm && !showSuccess && (
        <motion.div
        ...
        >
          ...
          >
            ...
            <motion.div
              animate={{ rotate: isPeeling ? 45 : 0, y: isPeeling ? -20 : 0 }}
              ...
              style={{
                ...
                width: '60px',
                height: '60px',
                background: 'linear-gradient(135deg, rgba(255, 42, 42, 0.3) 0%, rgba(255, 42, 42, 0.1) 100%)',
